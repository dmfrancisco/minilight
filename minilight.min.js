...
`}},x=()=>{switch(r){case e.whitespace:return s.unformatted;case e.operator:case e.closingBrace:return s.punctuation;case e.word:return y.includes(i)?s.keyword:s.unformatted;case e.regex:case e.stringDouble:case e.stringSingle:case e.stringTemplate:return s.string;case e.xmlComment:case e.multiLineComment:case e.singleLineCommentSlash:case e.singleLineCommentHash:return s.comment}},C=()=>t==="#"?e.singleLineCommentHash:t+l==="//"?e.singleLineCommentSlash:t+l==="/*"?e.multiLineComment:t+l+o[c+1]+o[c+2]==="<!--"?e.xmlComment:t==="`"?e.stringTemplate:t==="'"?e.stringSingle:t==='"'?e.stringDouble:t==="/"&&[e.whitespace,e.operator].includes(g)&&n!="<"?e.regex:/[$\w]/.test(t)?e.word:/[\])]/.test(t)?e.closingBrace:/[\/{}[(\-+*=<>:;|\\.,?!&@~]/.test(t)?e.operator:e.whitespace;for(;m=n,n=!h.includes(r)&&n==="\\"?!0:t;){if(t=l,l=o[++c],a=i.length>1,w()){if(i){const d=document.createElement("span"),f=x();f&&d.setAttribute("style",f),d.appendChild(document.createTextNode(i)),u.appendChild(d)}r!==e.whitespace&&!h.includes(r)&&(g=r),i="",r=C()}i+=t}};
